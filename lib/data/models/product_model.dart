...
class ProductModel extends Equatable {
  ...
  factory ProductModel.fromJson(Map<String, dynamic> json, Map<String, int> allCategories) => ProductModel(
      ...
      produceCoordinates: !json["vendor_details"][0]["location"]["longitude"]
                  .toString()
                  .contains("0.0") &&
              !json["vendor_details"][0]["location"]["latitude"].toString().contains("0.0") &&
              json["vendor_details"][0]["location"]["longitude"] != null &&
              json["vendor_details"][0]["location"]["latitude"] != null
          ? LatLng(latitude: double.parse(json["vendor_details"][0]["location"]["latitude"]), longitude: double.parse(json["vendor_details"][0]["location"]["longitude"]))
          : null);
